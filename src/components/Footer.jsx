                    ...
                    <div className="row g-5 mb-5">
                        <div className="col-lg-4">
                            ...
                            <ul className="list-unstyled custom-social">
                                <li><Link to="https://www.facebook.com/" target='_blank'><span className="fa fa-brands fa-facebook-f" /></Link></li>
                                <li><Link to="#"><span className="fa fa-brands fa-twitter" /></Link></li>
                                <li><Link to="https://www.instagram.com/" target='_blank'><span className="fa fa-brands fa-instagram" /></Link></li>
                                <li><Link to="https://www.linkedin.com/" target='_blank'><span className="fa fa-brands fa-linkedin" /></Link></li>
                            </ul>
                        </div>
                        <div className="col-lg-8">
                    ...
                    <div className="border-top copyright">
                        <div className="row pt-4">
                            <div className="col-lg-6">
                                <p className="mb-2 text-center text-lg-start">Copyright ©. All Rights Reserved. — Designed with love by <Link to="https://untree.co">Untree.co</Link> Distributed By <Link tof="https://themewagon.com">ThemeWagon</Link>  {/* License information: https://untree.co/license/ */ }
                                </p>
                            </div>
